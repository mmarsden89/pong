...
import * as serviceWorker from './serviceWorker';
  ...
  var player, racket, cursor, ball, wall, scoreTextPlayer,
  scoreTextPc, rect, circle, court, divider, pc, pcracket, pchit, circle2
  var pcVelocity = 0
  var scorePlayer = 0
  var scorePc = 0
  ...
  //function in which objects are created
    ...
    scoreTextPlayer = this.add.text(1100, 16, 'score: 0', { fontSize: '16px', fill: '#00F' });
  }
  ...
  function updateGame () {
    ...
    circle2.x = pc.body.x + 32.5
    circle2.y = pc.body.y + 57.5
